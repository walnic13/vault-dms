...
Turn issued against HEAD: <<PKG_COMMIT>> (development; the commit that first adds this package — T29 artifact-presence probe resolves here and at every later commit; grounding reads were against parent 497b4fd)
